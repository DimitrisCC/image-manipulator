...
namespace imaging
{
	...
	public:
		// Constructors 
		Block(const size_t & block_size);   // Create an empty block. There is no default constructor. It doesn't make sense.
	...
	public:
		...
		Component & operator*() const;               // content retrieval operator. Remember,
